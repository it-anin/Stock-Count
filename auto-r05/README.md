...
> ⚠️ **เวลาของข้อ 1 ยังไม่เคยตรวจกับของจริง** — `BOTR05106/README.md` §สถานะการติดตั้งจริง บันทึกไว้แค่ว่า
> "ตั้ง Scheduled Task แล้ว ทดสอบผ่าน" บนเครื่องนั้น **แต่ไม่ได้ระบุเวลา** ส่วนเลข `06:30` ที่ปรากฏในไฟล์นั้น
> อยู่ในบล็อก**ตัวอย่างคำสั่ง** `register_task.ps1` ไม่ใช่บันทึกว่าตั้งไว้กี่โมงจริง
> ⇒ **ต้องไปอ่านจากเครื่องที่รันจริงก่อนตั้ง Task ตัวนี้เสมอ** (กฎ 0 ใน `CLAUDE.md`: สถานะ runtime ห้ามอนุมาน)
...
Get-ScheduledTask -TaskName "ProMaxxReportBot" |
