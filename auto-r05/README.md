...
เอกสารนี้ใช้ **07:30** เป็นตัวอย่างตลอด แต่**เวลาจริงต้องเลือกจากเวลาที่ไฟล์ export เสร็จบนเครื่องนั้น**
(ดู §ขั้น 0) — ตั้งเร็วไปจะเจอไฟล์เมื่อวานแล้วหยุดด้วย exit 4 ทุกวัน
...
| 2 | **`auto-r05` (โฟลเดอร์นี้)** | **อ่านไฟล์นั้น → เขียน `global_r05` บน Firestore** | ตั้งหลังข้อ 1 อย่างน้อย 30 นาที |
...
### ขั้น 0 — หาเวลาจริงก่อน (ห้ามข้าม)
...
ตั้ง Task ตัวนี้ **หลังเวลา (ก) อย่างน้อย 30 นาที** · ตั้งเร็วไปจะเจอไฟล์เมื่อวานแล้วหยุดด้วย exit 4 ทุกวัน
(ปลอดภัยเพราะไม่เขียนอะไร แต่ก็ไม่ได้ทำงาน)
